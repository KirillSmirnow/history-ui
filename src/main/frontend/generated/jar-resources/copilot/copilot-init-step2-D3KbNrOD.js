    ...
    constructor() {
        super(...arguments), this.position = "right", this.opened = !1, this.keepOpen = !1, this.resizing = !1, this.closingForcefully = !1, this.draggingSectionPanel = null, this.activationAnimationTransitionEndListener = () => {
            ...
            this.getAllPanels().sort((e, o) => {
                const n = e.getBoundingClientRect(), i = o.getBoundingClientRect(), r = (n.top + n.bottom) / 2,
                    s = (i.top + i.bottom) / 2;
                return r - s;
            }).forEach((e, o) => {
...
class mt {
    ...
    dragging(e, o) {
        const n = o.clientX, i = o.clientY, r = n - this.offsetX,
            s = n - this.offsetX + e.getBoundingClientRect().width, c = i - this.offsetY,
            h = i - this.offsetY + e.getBoundingClientRect().height;
        return this.adjust(e, r, c, s, h);
    }

    adjust(e, o, n, i, r) {
        let s, c, h, P;
        const I = document.documentElement.getBoundingClientRect().width,
    ...
    constructor() {
        super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.mouseDownListener = (t) => {
            this.initialMouseDownPosition = {
                x: t.clientX,
                y: t.clientY
            }, m.draggingStarts(this, t), document.addEventListener("mousemove", this.documentDraggingMouseMoveEventListener);
    ...
    constructor() {
        super(...arguments), this.panelTag = "", this.dockingItems = [
            ...
            if (!this.panelInfo?.floating || this.floatingResizingStarted || !this.panelInfo?.expanded)
                return;
            const e = this.getBoundingClientRect(), o = Math.abs(t.clientX - e.x),
                n = Math.abs(e.x + e.width - t.clientX), i = Math.abs(t.clientY - e.y),
                r = Math.abs(e.y + e.height - t.clientY), s = Number.parseInt(
            ...
            if (o < s ? i < s ? (c = "nw-resize", this.setAttribute(g, "top left")) : r < s ? (c = "sw-resize", this.setAttribute(g, "bottom left")) : (c = "col-resize", this.setAttribute(g, "left")) : n < s ? i < s ? (c = "ne-resize", this.setAttribute(g, "top right")) : r < s ? (c = "se-resize", this.setAttribute(g, "bottom right")) : (c = "col-resize", this.setAttribute(g, "right")) : r < s ? (c = "row-resize", this.setAttribute(g, "bottom")) : i < s && (c = "row-resize", this.setAttribute(g, "top")), c !== "") {
                const h = window.getComputedStyle(this), P = Number.parseInt(h.borderTopWidth, 10),
                    I = Number.parseInt(h.borderTopWidth, 10), C = Number.parseInt(h.borderLeftWidth, 10),
                    J = Number.parseInt(h.borderRightWidth, 10);
            ...
            const i = window.getComputedStyle(this), r = Number.parseFloat(i.getPropertyValue("--header-height")),
                s = Number.parseFloat(i.getPropertyValue("--floating-offset-resize-threshold")) / 2;
            ...
            const {width: e, height: o} = this.getBoundingClientRect(), {
                    left: n,
                    top: i,
                    bottom: r,
                    right: s
                } = m.anchor(this), c = window.getComputedStyle(this.container), h = Number.parseInt(c.borderTopWidth, 10),
                P = Number.parseInt(c.borderTopWidth, 10);
