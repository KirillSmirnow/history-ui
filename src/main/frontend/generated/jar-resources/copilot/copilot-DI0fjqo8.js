...
function zo(e, t) {
    ...
    function a(l, s) {
        var c, d, u = Ue(l)[g],
            f = new ge(s, (c = (d = r.options_) == null ? void 0 : d.enhancer) != null ? c : me, process.env.NODE_ENV !== "production" ? u.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
var na = {
    ...
    }, A = /* @__PURE__ */ Dn(Kn, na), Hn = "computed", ia = "computed.struct", pr = /* @__PURE__ */ xr(Hn),
    oa = /* @__PURE__ */ xr(ia, {
...
var Dr = "action", Ea = "action.bound", ii = "autoAction", Oa = "autoAction.bound", oi = "<unnamed action>",
    _r = /* @__PURE__ */ ut(Dr), Aa = /* @__PURE__ */ ut(Ea, {
        bound: !0
    }), mr = /* @__PURE__ */ ut(ii, {
        autoAction: !0
    }), Sa = /* @__PURE__ */ ut(Oa, {
...
function si(e, t) {
    ...
    var l = (r = (n = t) == null ? void 0 : n.name) != null ? r : process.env.NODE_ENV !== "production" ? e.name || "Autorun@" + I() : "Autorun",
        s = !t.scheduler && !t.delay, c;
    if (s)
        c = new Ye(l, function () {
            this.track(f);
...
function ci(e, t, r) {
    ...
    var l = (n = r.name) != null ? n : process.env.NODE_ENV !== "production" ? "Reaction@" + I() : "Reaction",
        s = fe(l, r.onError ? xa(r.onError, t) : t), c = !r.scheduler && !r.delay, d = li(r), u = !0, f = !1, p,
        y = r.compareStructural ? Ve.structural : r.equals || Ve.default, m = new Ye(l, function () {
            u || c ? S() : f || (f = !0, d(S));
...
var or = /* @__PURE__ */ Mn("flow"), ja = /* @__PURE__ */ Mn("flow.bound", {
    ...
    var n = t, i = n.name || "<unnamed flow>", o = function () {
        var l = this, s = arguments, c = ++Va, d = fe(i + " - runid: " + c + " - init", n).apply(l, s), u, f = void 0,
            p = new Promise(function (y, m) {
                var S = 0;
                u = m;
...
var _i = /* @__PURE__ */ function () {
    ...
    return t.has_ = function (n) {
        ...
        W(this.keysAtom_), Z(function () {
            var c,
                d = new ge(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + hr(n) : "ObservableMap.key", !1);
...
var wi = /* @__PURE__ */ function () {
    ...
    }(), Ie = /* @__PURE__ */ Se("ObservableSet", wi), Yr = /* @__PURE__ */ Object.create(null), Qr = "remove",
...
Extending builtins is not supported.`), e;
    ...
    var n = (r = t?.name) != null ? r : process.env.NODE_ENV !== "production" ? (D(e) ? "ObservableObject" : e.constructor.name) + "@" + I() : "ObservableObject",
        i = new yr(e, /* @__PURE__ */ new Map(), String(n), ta(t));
    return Ht(e, g, i), e;
}
...
const Re = "copilot-", ts = "24.4.9", Pl = "attention-required",
    Cl = "https://plugins.jetbrains.com/plugin/23758-vaadin",
    Tl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode",
    Vl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, rs = (e) => {
        const t = [];
        let r = is(e);
        for (; r;)
 ...
 */
const xt = globalThis,
    Rr = xt.ShadowRoot && (xt.ShadyCSS === void 0 || xt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    kr = Symbol(), ln = /* @__PURE__ */ new WeakMap();
let Vi = class {
    constructor(t, r, n) {
...
const {
        ...
        getPrototypeOf: ys
    } = Object, er = globalThis, un = er.trustedTypes, ws = un ? un.emptyScript : "",
    Es = er.reactiveElementPolyfillSupport, Xe = (e, t) => e, Er = {
        toAttribute(e, t) {
            switch (t) {
                case Boolean:
                    e = e ? ws : null;
...
let Pe = class extends HTMLElement {
    ...
    static getPropertyDescriptor(t, r, n) {
        const {get: i, set: o} = bs(this.prototype, t) ?? {
            get() {
                return this[r];
            }, set(a) {
                this[r] = a;
    ...
    _$AK(t, r) {
        ...
        if (i !== void 0 && this._$Em !== i) {
            const o = n.getPropertyOptions(i),
                a = typeof o.converter == "function" ? {fromAttribute: o.converter} : o.converter?.fromAttribute !== void 0 ? o.converter : Er;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Lr = globalThis, It = Lr.trustedTypes, vn = It ? It.createPolicy("lit-html", {createHTML: (e) => e}) : void 0,
    Mr = "$lit$", Y = `lit$${(Math.random() + "").slice(9)}$`, Ir = "?" + Y, Ss = `<${Ir}>`, Oe = document,
    it = () => Oe.createComment(""), ot = (e) => e === null || typeof e != "object" && typeof e != "function",
    Ri = Array.isArray, ki = (e) => Ri(e) || typeof e?.[Symbol.iterator] == "function", lr = `[ 	
\f\r]`, He = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, fn = /-->/g, pn = />/g,
    de = RegExp(`>|${lr}(?:([^\\s"'>=/]+)(${lr}*=${lr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), gn = /'/g, bn = /"/g, Li = /^(?:script|style|textarea|title)$/i,
    Mi = (e) => (t, ...r) => ({_$litType$: e, strings: t, values: r}), Ut = Mi(1), Kl = Mi(2),
    le = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), _n = /* @__PURE__ */ new WeakMap(),
    pe = Oe.createTreeWalker(Oe, 129);
...
class ze {
    ...
    $(t) {
        const {values: r, _$litType$: n} = t,
            i = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = at.createElement(Ii(n.h, n.h[0]), this.options)), n);
...
class Hi extends pt {
    ...
    _$AI(t, r = this) {
        ...
        const n = this._$AH,
            i = t === O && n !== O || t.capture !== n.capture || t.once !== n.once || t.passive !== n.passive,
            o = t !== O && (n === O || i);
...
const Ns = {P: Mr, A: Y, C: Ir, M: 1, L: Ui, R: zi, D: ki, V: Ae, I: ze, H: pt, N: Ki, U: Hi, B: Bi, F: Fi},
    xs = Lr.litHtmlPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const qi = {ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6},
    Wi = (e) => (...t) => ({_$litDirective$: e, values: t});
let Gi = class {
    constructor(t) {
    }
...
const Yi = () => {
    ...
    }, Ks = async () => Ti(`${Re}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)),
    Hs = async () => Ci(() => b.userInfo), Gl = async () => (await Hs()).vaadiner;
...
const wn = (e) => {
    ...
    }, Zs = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey,
    ne = Ws(), Xl = {
